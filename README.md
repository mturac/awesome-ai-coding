...
- [hermes-supercode-skills](https://github.com/mturac/hermes-supercode-skills) — 13 production-grade Claude Code skills: db-whisperer, auth-architect, obs-guardian, deploy-ninja, security-sentinel, quantum-debugger, api-sculptor, pipeline-architect + more
